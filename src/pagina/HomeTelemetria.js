...
function HomeTelemetria() {
    ...
    useEffect(() => {
        const GetData = async () => {
            const result = await axios('http://localhost:5000/postagemtelemetria');
            setData(result.data);
        };
                                        ...
                                        <Card >
                                            ...
                                            <CardBody>
                                                ...
                                                <CardSubtitle
                                                    ...
                                                    tag="h6"
                                                >
                                                    <h3 key={postagem} style={{ maxWidth: "50ch", overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>Autor: {postagem.autor}</h3>
                                                </CardSubtitle>
                                                <CardText>
