...
function HomeQualidade() {
    ...
    return (
        <div style={{ paddingTop: '3em' }}>
            <BarraDeTarefa />
            <img src="/assets/bannerQualidade.png" style={{ width: '100%' }} alt="imgFromIberia" />
            <Container >
                <Row>
                    <Col>
                        <Container>
                            <h1>Historia sobre a Qualidade</h1>
                            <Row
                                md="2"
                                sm="2"
                                xs="1">
                                ...
                                <Col>
                                    <img src="assets/bannerQualidade.png" style={{ width: '100%' }} />
                                </Col>
                            </Row>
                        </Container>
                    </Col>
