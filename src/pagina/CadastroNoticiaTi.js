...
function CadastroNoticiaTi() {

    const [newPostagem, setNewPostagem] = useState({ titulo: '', conteudo: '', autor: '' });
    const url = 'http://localhost:5000/postagemti/novapostagem';
...
export default CadastroNoticiaTi;