...
function CadastroNoticiaRh() {

    const [newPostagem, setNewPostagem] = useState({ titulo: '', conteudo: '', autor: '' });
    const url = 'http://localhost:5000/postagemrh/novapostagem';
    ...
    return (
        <Container
            ...
            <Row>
                ...
                <Col>
                    <h3>Nova Postagem Recursos Humanos</h3>
                </Col>
                <Col>
                </Col>
            </Row>
...
export default CadastroNoticiaRh;