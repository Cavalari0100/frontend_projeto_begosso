...
function NoticiaRh(props) {
    const {id} = useParams()
    const [data, setData] = useState({});
    
    useEffect(() => {
        const GetData = async () => {
            const result = await axios('http://localhost:5000/postagemrh/noticiarh/' + id);
            setData(result.data);
        };
        ...
        >
            ...
            <Container>
                ...
                <Row>
                    <Col></Col>
                    <Col></Col>
                    <Col><div><Button href='/homerh'>Voltar ao RH</Button></div></Col>
                </Row>
